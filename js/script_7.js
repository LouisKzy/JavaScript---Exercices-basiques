...
function acneBot() {
  let weshWesh = prompt("Wesh le fréro sa dit quoi ?");
  
  if (weshWesh.endsWith("?")) {
    console.log("Ouais Ouais...");
  } else if (weshWesh === weshWesh.toUpperCase() && weshWesh !== "") {
    console.log("Pwa calme twa...");
  } else if (weshWesh.includes("Fortnite")) {
